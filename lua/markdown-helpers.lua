...
local function dedent_line()
  ...
  vim.api.nvim_buf_set_lines(0, line_nr - 1, line_nr, false, { dedented_line })
end

-- Set keymaps for Markdown helpers
local function set_keymaps()
  vim.api.nvim_set_keymap("n", "<CR>", ":lua require('markdown-helpers').toggle_checkbox()<CR>", { noremap = true, silent = true })
  vim.api.nvim_set_keymap("n", "o", ":lua require('markdown-helpers').add_checkbox()<CR>", { noremap = true, silent = true })
  vim.api.nvim_set_keymap("n", "<Tab>", ":lua require('markdown-helpers').indent_line()<CR>", { noremap = true, silent = true })
  vim.api.nvim_set_keymap("n", "<S-Tab>", ":lua require('markdown-helpers').dedent_line()<CR>", { noremap = true, silent = true })
end
